...
if (args.dat[1]=='RStudio') {
  ...
  opt$joinFull   <- FALSE
  opt$expDirName <- 'VA_Controls'
  # opt$outDirName <- paste(opt$expDirName, 'innerJoin', sep='.')
  opt$outDir     <- file.path('/Users/bbarnes/Documents/Projects/methylation/VA_MVP/scratch', par$prgmTag)
  # opt$buildDir   <- file.path('/Users/bbarnes/Documents/Projects/methylation/VA_MVP/scratch/swifthoof_main', opt$expDirName)
  opt$buildDir   <- file.path('/Users/bbarnes/Documents/Projects/methylation/VA_MVP/scratch/swifthoof_main')
