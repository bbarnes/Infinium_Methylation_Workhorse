...
man_cpg_pos_tib <- 
  addGenomicToMAN(man=man_cpg_prb_tib, pos_tsv=opt$cpg_pos_tsv, 
...
if (par$local_runType=='GRCm38') {
  ...
  all_add_rep_tib <- 
    manifestCheckSummary(man_ana_prb_tib, verbose=opt$verbose,vt=1,tc=1,tt=pTracker)
  
} else {
  #
  # TBD:: Add the above as a function...
  #
}
